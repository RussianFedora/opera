...
Source0:    ftp://ftp.opera.com/pub/opera/linux/1161/%{name}-%{version}-%{origver}.x86_64.rpm
Source1:    ftp://ftp.opera.com/pub/opera/linux/1161/%{name}-%{version}-%{origver}.i386.rpm
